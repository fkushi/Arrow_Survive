...
public :
	Test() {
		...
		t2k::Vector3 goal = point[ getNextPoint() ];
		t2k::Vector3 v = goal - pos_;
		tf_move.setMethodBrake(&pos_, goal, v.normalize(), v.length(), 2.0f);
	}

	static constexpr int POINT_MAX = 3 ;
	t2k::Vector3 point[POINT_MAX] = {
		{100, 100, 0},
		{500, 500, 0},
		{800, 100, 0}
	};
	...
	t2k::Vector3 pos_ ;
	t2k::TimerFluct<t2k::Vector3> tf_move;
